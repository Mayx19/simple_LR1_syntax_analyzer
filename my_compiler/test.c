...
//--------------------------r part
        ...
        LR1(syntax, act_go_map1); // generate action-goto table
        ...
        /////////////////////////////////
        print_action_goto_table(syntax, act_go_map1);
        ...
        //////////////////////////////////
        uint rows=LR1(syn, act_go_map2);

        print_action_goto_table(syn, act_go_map2);
        char buffer[1024];
        // const char * buffer="abc\0";
        int pos = 0;
        lexical_temp *lexical_t = init_lexical_temp();
        while (gets(buffer))
        {
            pos = 0;
